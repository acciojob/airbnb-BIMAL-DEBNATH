...
public class HotelManagementController {
    ...
    public String addHotel(@RequestBody Hotel hotel) {
        ...
        //incase the hotel Name is null or the hotel Object is null return an empty a FAILURE
        //Incase somebody is trying to add the duplicate hotelName return FAILURE
        //in all other cases return hotel Name after successfully adding the hotel to the hotelDb.
    ...
    public String getHotelWithMostFacilities() {
        //Out of all the hotels we have added so far, we need to find the hotelName with must no of facilities
    ...
    public int bookARoom(@RequestBody Booking booking) {
        ...
        // Mave bookingId as a random UUID generated string
        // save the booking Entity and keep the bookingId as a primary key
        // Calculate the total amount paid by the person based on no. of rooms booked and price of the room per night.
        // If there arent enough rooms available in the hotel that we are trying to book return -1
        // in other case return total amount paid I
